...
export interface Thenable<T> {
    then<R1 = T, R2 = never>(this: Thenable<T>, onfulfilled?: ((value: T) => R1 | Thenable<R1>) | null | undefined, onrejected?: ((reason: any) => R2 | Thenable<R2>) | null | undefined): Thenable<R1 | R2>;
    then<R1 = T>(this: Thenable<T>, onfulfilled?: ((value: T) => R1 | Thenable<R1>) | null | undefined, onrejected?: ((reason: any) => void) | null | undefined): Thenable<R1 | void>;
}
/**
 ...
 */
export declare type ErrorClass = new (...args: any[]) => Error;
...
export declare class Promise<T> implements Thenable<T>, Inspection<T> {
     ...
     */
    then<R1 = T, R2 = never>(onFulfilled: ((value: T) => R1 | Thenable<R1>) | null | undefined, onRejected?: ((reason: any) => R2 | Thenable<R2>) | null | undefined): Promise<R1 | R2>;
    /**
     * Run either `onFulfilled` or `onRejected` callbacks when the promise is
